...
// Mark the execution in the "__spec__" value.
    ...
    branch_no_7:;
    {
        ...
        PyObject *tmp_add_expr_left_1;
        PyObject *tmp_add_expr_right_1;
        tmp_iadd_expr_left_1 = GET_STRING_DICT_VALUE(moduledict_pyparsing, (Nuitka_StringObject *)mod_consts[77]);

        if (unlikely(tmp_iadd_expr_left_1 == NULL)) {
            tmp_iadd_expr_left_1 = GET_MODULE_VARIABLE_VALUE_FALLBACK(mod_consts[77]);
        }
        ...
        tmp_add_expr_left_1 = GET_STRING_DICT_VALUE(moduledict_pyparsing, (Nuitka_StringObject *)mod_consts[91]);

        if (unlikely(tmp_add_expr_left_1 == NULL)) {
            tmp_add_expr_left_1 = GET_MODULE_VARIABLE_VALUE_FALLBACK(mod_consts[91]);
        }
        ...
        tmp_add_expr_right_1 = GET_STRING_DICT_VALUE(moduledict_pyparsing, (Nuitka_StringObject *)mod_consts[79]);

        if (unlikely(tmp_add_expr_right_1 == NULL)) {
            tmp_add_expr_right_1 = GET_MODULE_VARIABLE_VALUE_FALLBACK(mod_consts[79]);
        }
