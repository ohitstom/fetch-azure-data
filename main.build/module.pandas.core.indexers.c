...
static PyCodeObject *codeobj_a60738b9e2ba9b386cd52d9eed2c331d;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[36]); CHECK_OBJECT(module_filename_obj);
    codeobj_a60738b9e2ba9b386cd52d9eed2c331d = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[37], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_a60738b9e2ba9b386cd52d9eed2c331d;
    ...
    // Frame without reuse.
    frame_a60738b9e2ba9b386cd52d9eed2c331d = MAKE_MODULE_FRAME(codeobj_a60738b9e2ba9b386cd52d9eed2c331d, module_pandas$core$indexers);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_a60738b9e2ba9b386cd52d9eed2c331d);
    assert(Py_REFCNT(frame_a60738b9e2ba9b386cd52d9eed2c331d) == 2);
    ...
    // Framed code:
    {
        ...
        frame_a60738b9e2ba9b386cd52d9eed2c331d->m_frame.f_lineno = 1;
        {
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_a60738b9e2ba9b386cd52d9eed2c331d);
#endif
    popFrameStack();

    assertFrameObject(frame_a60738b9e2ba9b386cd52d9eed2c331d);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_a60738b9e2ba9b386cd52d9eed2c331d, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_a60738b9e2ba9b386cd52d9eed2c331d->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_a60738b9e2ba9b386cd52d9eed2c331d, exception_lineno);
    }
