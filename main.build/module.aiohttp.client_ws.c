...
static PyObject *aiohttp$client_ws$$$function__18_close$$$coroutine__1_close_context(struct Nuitka_CoroutineObject *coroutine, PyObject *yield_return_value) {
    ...
    }
    {
        ...
        tmp_assign_source_3 = LOOKUP_SPECIAL(tmp_expression_value_22, mod_consts[66]);
    ...
    }
    {
        ...
        tmp_called_value_4 = LOOKUP_SPECIAL(tmp_expression_value_25, mod_consts[67]);
        ...
        Nuitka_PreserveHeap(coroutine_heap->yield_tmps, &tmp_expression_value_24, sizeof(PyObject *), &tmp_called_value_4, sizeof(PyObject *), &tmp_expression_value_25, sizeof(PyObject *), NULL);
        ...
        yield_return_3:
        Nuitka_RestoreHeap(coroutine_heap->yield_tmps, &tmp_expression_value_24, sizeof(PyObject *), &tmp_called_value_4, sizeof(PyObject *), &tmp_expression_value_25, sizeof(PyObject *), NULL);
        coroutine->m_awaiting = false;
...
static PyObject *aiohttp$client_ws$$$function__19_receive$$$coroutine__1_receive_context(struct Nuitka_CoroutineObject *coroutine, PyObject *yield_return_value) {
    ...
    }
    {
        ...
        tmp_assign_source_2 = LOOKUP_SPECIAL(tmp_expression_value_9, mod_consts[66]);
        if (tmp_assign_source_2 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
        ...
        tmp_called_value_2 = LOOKUP_SPECIAL(tmp_expression_value_12, mod_consts[67]);
        if (tmp_called_value_2 == NULL) {
            assert(ERROR_OCCURRED());
        ...
        coroutine->m_frame->m_frame.f_lineno = 228;
        tmp_expression_value_11 = CALL_FUNCTION_NO_ARGS(tmp_called_value_2);
        Py_DECREF(tmp_called_value_2);
        if (tmp_expression_value_11 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    // Tried code:
    {
        ...
        tmp_assign_source_7 = LOOKUP_ATTRIBUTE(tmp_expression_value_22, mod_consts[19]);
